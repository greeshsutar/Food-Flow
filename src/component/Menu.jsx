...
export default function Menu() {
  ...
  useEffect(() => {
    async function menudata() {
      try {
        let data =
          "https://www.swiggy.com/mapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=15.796320490637022&lng=74.47427418082952&restaurantId=445632&submitAction=ENTER";
        ...
        return (
          <div className="flex flex-row-reverse items-start  border-b-2   border-gray-300     justify-between p-4">
            ...
            <div className="mt-3  ml-6">
              ...
              <h1>{[item.card.info.name].length}</h1>
